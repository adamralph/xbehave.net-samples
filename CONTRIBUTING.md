...
First of all, thank you for wanting to contribute to xBehave.net samples! We really appreciate all the awesome support we get from our community. We want to keep it as easy as possible to contribute changes that get things working in your environment. There are a few guidelines we need contributors to follow to keep the project flowing smoothly.
...
1. Test the build locally by running `rake` (see ['How to build'](https://github.com/xbehave/xbehave.net-samples/blob/master/how_to_build.md/))
...
1. Send a descriptive [Pull Request](http://help.github.com/pull-requests/) on GitHub.
  * Make sure the pull request is **from** the branch on your fork **to** the xbehave/xbehave.net master branch.
